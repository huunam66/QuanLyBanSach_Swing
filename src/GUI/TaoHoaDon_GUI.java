...
public class TaoHoaDon_GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_XoaInOrder.setText("Giảm trừ");
        ...
        spin_slChoose.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                spin_slChooseKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                spin_slChooseKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                spin_slChooseKeyTyped(evt);
            }
        });
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addComponent(text_TenKhachMoi, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
...
//                System.out.print("\n" + this.slChoose);
    ...
    private void spin_slSachOrderTrKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_spin_slSachOrderTrKeyReleased
        // TODO add your handling code here:
        if(Integer.parseInt(spin_slSachOrderTr.getValue().toString()) < 1)
            spin_slSachOrderTr.setValue(1);
        else
            if(Integer.parseInt(spin_slSachOrderTr.getValue().toString()) > Integer.parseInt(text_slSachOrder.getText()))
                spin_slSachOrderTr.setValue(text_slSachOrder.getText());
    ...
    private void btn_ThanhToanMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_ThanhToanMouseReleased
        ...
        DefaultTableModel tableModel = (DefaultTableModel)table_SachOrder.getModel();
        if(tenKhach.equals("") || sdtKhach.equals("") || dchiKhach.equals("")){
            ...
            int result = HoaDon_DAO.addNewHoaDon(this.maNV, ngayThanhToan);
            if(result <= 0){
            ...
            for(int i = 0; i < numRow; i++){
                String tenSach = table_SachOrder.getValueAt(i, 0).toString();
                String maCT_HD = maHD;
                String maSach = String.valueOf(Sach_DAO.getMaSach(tenSach));
...
//            new HoaDon_GUI(trangChu_GUI);
    ...
    private void eventKey_spin_slChoose(){
        spin_slChoose.addKeyListener(new KeyListener() {
            public void stateChanged(ChangeEvent e) {
                // Làm gì đó khi giá trị của JSpinner thay đổi
                if(Integer.parseInt(spin_slChoose.getValue().toString()) < 1)
                    spin_slChoose.setValue(1);
                else
                    if(table_SachOrder.getSelectedRowCount() == 1){
                        if(Integer.parseInt(spin_slChoose.getValue().toString()) > Integer.parseInt(table_SachChoose.getValueAt(table_SachChoose.getSelectedRow(), 3).toString()))
                        spin_slChoose.setValue(Integer.parseInt(table_SachChoose.getValueAt(table_SachChoose.getSelectedRow(), 3).toString()));
                    }
    ...
    private void spin_slChooseKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_spin_slChooseKeyReleased
        // TODO add your handling code here:
        
    }//GEN-LAST:event_spin_slChooseKeyReleased

    private void spin_slChooseKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_spin_slChooseKeyPressed
        // TODO add your handling code here:
        
    }//GEN-LAST:event_spin_slChooseKeyPressed

    private void spin_slChooseKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_spin_slChooseKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_spin_slChooseKeyTyped

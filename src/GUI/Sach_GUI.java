...
public class Sach_GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        picker_NgayXuatBan = new com.toedter.calendar.JDateChooser();
        ...
        btn_nhapsach = new javax.swing.JButton();
        ...
        picker_NgayXuatBan.setDateFormatString("dd/MM/yyyy");
        picker_NgayXuatBan.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        picker_NgayXuatBan.setPreferredSize(new java.awt.Dimension(83, 25));
        ...
        txt_tonkho.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        txt_tonkho.setFocusable(false);
        txt_tonkho.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_tonkhoKeyPressed(evt);
            }
        });
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txt_tonkho, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    ...
                                    .addComponent(picker_NgayXuatBan, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(text_gia, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addContainerGap())))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jLabel21)
                .addGap(3, 3, 3)
                .addComponent(picker_NgayXuatBan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel20)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        txt_tonkho.getAccessibleContext().setAccessibleName("tonkho_txt");
        ...
        btn_nhacungcap.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ...
        btn_nhapsach.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btn_nhapsach.setText("Nhập sách");
        btn_nhapsach.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_nhapsachMouseClicked(evt);
            }
        });
        btn_nhapsach.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_nhapsachActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(btn_nhapsach, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(btn_nhacungcap, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(btn_TheLoaiSach, javax.swing.GroupLayout.PREFERRED_SIZE, 206, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(30, 30, 30))
...
//            String maSach = text_maSach.getText();
                ...
                String theLoai = String.valueOf(TheLoai_DAO.getMaTheLoai(cbb_TheLoai.getSelectedItem().toString()));
                ...
                if(JOptionPane.showConfirmDialog(this, "Đồng ý thêm mới ?", "Thông báo", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.OK_OPTION){
                    int result = Sach_DAO.addNewSach(tenSach, gia, "0",tacGia, ngayXuatBan, nhaXuatBan, theLoai);

                    if(result == 1){
                        JOptionPane.showConfirmDialog(this, "Thêm mới thành công !", "Thông báo", JOptionPane.OK_OPTION, JOptionPane.INFORMATION_MESSAGE);
                    }
    ...
    private void Table_SachMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Table_SachMouseClicked
        ...
        if(Table_Sach.getSelectedRowCount() == 1){
            ...
            txt_tonkho.setText(valueColumn.get(3));
    ...
    private void btn_SuaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_SuaMouseClicked
        ...
        if(Table_Sach.getSelectedRowCount() == 1){
            if(JOptionPane.showConfirmDialog(this, "Đồng ý sửa sách này ?", "Thông báo", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.OK_OPTION){
                ...
                int result = Sach_DAO.updateSach(maSach, tenSach, gia, "0", tacGia, ngayXuatBan, nhaXuatBan, theLoai);
    ...
    private void txt_tonkhoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_tonkhoKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_tonkhoKeyPressed

    private void btn_nhapsachMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_nhapsachMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_nhapsachMouseClicked
    ...
    private javax.swing.JButton btn_nhapsach;
    ...
    private com.toedter.calendar.JDateChooser picker_NgayXuatBan;
